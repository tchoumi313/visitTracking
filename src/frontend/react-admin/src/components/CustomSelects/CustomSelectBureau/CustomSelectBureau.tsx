...
const CustomSelectBureau: React.FC<CustomSelectInputProps> = ({
  inputLabel,
  inputPlaceholder,
  required,
  wrapperStyle,
  ...
  const handleOptionSelect = (selectedValue: BureauResponse) => {
    setInputValue(selectedValue.batiment + ' ' + selectedValue.etage + ' ' + selectedValue.porte);
        ...
        <ul>
          {isDropdownOpen && inputValue !== '' && (
            ...
            >
              ...
              >
                {matchList.length > 0 ? matchList.map((option: BureauResponse, index) => (
                  <li
                  ...
                  >
                    {option.batiment + ' ' + option.etage + ' ' + option.porte}
                  </li>
                )) :
                  <li
...
export default CustomSelectBureau;
