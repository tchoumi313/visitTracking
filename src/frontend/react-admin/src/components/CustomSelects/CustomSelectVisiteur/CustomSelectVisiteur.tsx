...
import { VisiteurResponse } from '../../../generated';


const CustomSelectVisiteur: React.FC<CustomSelectInputProps> = ({
  inputLabel,
  inputPlaceholder,
  required,
  wrapperStyle,
  ...
  const handleOptionSelect = (selectedValue: VisiteurResponse) => {
        ...
        <ul>
          {isDropdownOpen && inputValue !== '' && (
            ...
            >
              ...
              >
                {matchList.length > 0 ? matchList.map((option: VisiteurResponse, index) => (
                  <li
...
export default CustomSelectVisiteur;
