...
const SignIn: React.FC<SignInProps> = () => {
  ...
  return (
    <>
      <div className="rounded-sm border border-stroke bg-white shadow-default max-sm:pb-[110%] max-xl:pb-17 h-full dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="pt-0 pb-10 px-20 text-center">
              ...
              <p className="2xl:px-20">
                Heureux de vous revoir sur notre plateforme d'administration.<br></br>
                Gérez vos tâches et vos informations en toute sécurité et avec facilité.
              </p>
              
              {/* Image du telephone avec avatar a gauche  */}
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Accedez a votre espace personnel</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Se Connecter a Visitech
              </h2>
              ...
              <form>
                <div className="mb-4">
                  <label className="mb-2.5 flex font-medium text-black dark:text-white">
                    Email
                    <p className="text-danger font-bold mt-1">&thinsp;*</p>
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className={`peer w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${isError ? 'border-danger' : ''}`}
                    />
                    ...
                    <p className="mt-1 invisible peer-invalid:visible text-meta-7 text-sm">
                      Veillez fournir une adresse email valide.
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      type="password"
                      placeholder="8+ lettres avec majuscule, Une caractere speciale, pas d'espace"
                      onChange={handlePasswordChange}
                      className={`w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${isError ? 'border-danger' : ''}`}
                    />
                    ...
                    {isError && <div className="text-danger mt-1">{ error }</div>}
                  </div>
                </div>
                ...
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className={`peer w-full rounded-lg border border-primary bg-primary p-4 text-white font-bold transition hover:bg-opacity-90 ${isFormInvalid ? 'hover:bg-body cursor-not-allowed' : 'cursor-pointer'}`}
                  />
                </div>
              </form>
            </div>
