...
const Settings = () => {
  ...
  const [formValues, setFormValues] = useState({
    ...
    sexe: user.sexe ? user.sexe : 'masculin',
    dateNais: new Date(user.dateNais ? user.dateNais : ''),
  })
  ...
  // Composante de modification du mot de passe 
                ...
                <form action="#">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          name="dateNais"
                          type="date"
                          value={formValues.dateNais instanceof Date ? formValues.dateNais.toISOString().substring(0, 10) : formValues.dateNais}
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      ...
                      type="submit"
                      onClick={handleModifyPersonalInformation}
                    >
                      Save
                    </button>
                  </div>
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#" encType='multipart/form-data' onSubmit={handleModifyProfile}>
                  <div
                    id="FileUpload"
                    className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-primary bg-gray py-3 px-3 dark:bg-meta-4 sm:py-7"
                  >
                    <input
                      type="file"
                      accept="image/*"
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mt-5">
              ...
              <div className="p-7">
                ...
                <div className="mb-5.5">
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button
                      className={`flex justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-70 ${isErrorPass ? 'cursor-not-allowed hover:bg-body' : 'cursor-pointer'}`}
                      type="submit"
