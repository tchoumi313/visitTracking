    ...
    <DefaultLayout>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-2 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="h-[85%] w-[85%] rounded-full absolute drop-shadow-2 align-center self-center">
              <img className='h-full w-full max-h-full rounded-full bg-center self-center' src={BASE_PATH + '/users/profile/' + user.profile?.id} alt="User Profile" />
            </div>
          </div>
          <div className="mt-4">
            ...
            <p className="font-medium">{user.poste}</p>
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-125 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              ...
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                ...
                <span className="text-sm w-full">Rendez-Vous</span>
              </div>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                ...
                tempus ut. Donec fermentum blandit aliquet. Etiam dictum dapibus ultricies. Sed vel aliquet libero. Nunc a augue fermentum,
